...
9. Outside the firewall only: regenerate both crossing copies so they
   always match the shipped release - `node tools-dev/build-single-html.js`
   (-> meridian-grc-mockup.html, the one-file edition) and
